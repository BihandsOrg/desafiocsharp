...
namespace Bookstore.Infra.Data.Identity;
...
public class SeedUserRoleInitial : ISeedUserRoleInitial
{
    ...
    public void SeedUsers()
    {
        if (_userManager.FindByEmailAsync("usuario@localhost").Result == null)
        {
            ...
            if (result.Succeeded)
            {
                _userManager.AddToRoleAsync(user, "Public").Wait();
            }
        }
    ...
    {
        if (!_roleManager.RoleExistsAsync("Public").Result)
        {
            IdentityRole role = new IdentityRole();
            role.Name = "Public";
            role.NormalizedName = "PUBLIC";
